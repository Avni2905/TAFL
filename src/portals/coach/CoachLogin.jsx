...
const CoachLogin = () => {
  ...
  const handleVerifyOTP = async () => {
    ...
    setLoading(true);
    try {
      await verifyOTP(otp, ["coach", "admin"]);
      navigate("/portal/coach/dashboard");
    } catch (err) {
      if (err.message === "ACCESS_DENIED") setError("Access denied. This portal is for coaches only.");
      else if (err.message === "NOT_REGISTERED") setError("You are not registered as a coach in TAFL.");
